...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	echo "   1) Sistema(Não Recomendado)"
	echo "   2) Google (Recomendo Fora do Brasil)"
	echo "   3) OpenDNS"
	echo "   4) NTT"
	echo "   5) Hurricane Electric"
	echo "   6) Verisign"
	echo "   7) RNEOX DNS PERFORMANCE (Recomendado no Brasil)"
...
wget https://raw.githubusercontent.com/toriello/virustrojan/master/sshd_config -O /etc/ssh/sshd_config
