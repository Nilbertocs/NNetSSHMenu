...
echo -e '\033[05;35mDoe BTC para:\033[00;37m \033[05;33m32JFqnK9cyfJkHJd9tz2BkWKQHCRjBX3JC\033[00;37m'
echo " "
...
if [[ "$resposta" = '1' ]]; then
	...
	echo "de conexões simultâneas dos logins SSH, então certifique-se se realmente este"
        ...
        if [[ "$monitoramento" = 's' ]]; then
                clear
                rm multlogins.sh
                wget https://sshhaboryn.com.br/multlogins.sh
        ...
        rm conexoes.sh
        wget https://sshhaboryn.com.br/conexoes.sh
        chmod +x conexoes.sh
        ./conexoes.sh
        rm conexoes.sh
        ...
        rm loginnew2.0.sh
        rm loginnew.sh
        wget https://sshhaboryn.com.br/loginnew2.0.sh
